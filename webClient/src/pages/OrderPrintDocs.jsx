          ...
          <div style={{ display: "flex", justifyContent: "space-between", borderTop: "1px solid #333", paddingTop: "15px", marginBottom: "20px" }}>
            <div style={{ width: "48%" }}>
              ...
              <p style={{ margin: "5px 0 0 0" }}>
                <strong>Legal Entity Name:</strong> DHAN LAXMI ENTERPRISES<br />
                <strong>Address:</strong> Corporate Office, Dhanlaxmi Tower, Mumbai, Maharashtra<br />
                <strong>GSTIN:</strong> 27AADCD4946L1Z6<br />
                <strong>FSSAI License:</strong> 10019064001810
              </p>
            </div>
      ...
      {docType === "gst" && (
        <div>
          ...
          <div style={{ borderTop: "1px solid #333", paddingTop: "15px", marginBottom: "20px" }}>
            <strong>MANGALIK STORE (Governance: Dhanlaxmi Enterprises)</strong>
            <p style={{ margin: "5px 0 0 0" }}>
              <strong>PAN:</strong> AADCD4946L<br />
              <strong>CIN:</strong> L93030DL2010PLC198141<br />
              <strong>GSTIN:</strong> 29AADCD4946L1Z6<br />
