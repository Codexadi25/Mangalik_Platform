      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={4}>
          <Stack spacing={4}>
            ...
            {order.status === "delivered" && (
              <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: "1px solid", borderColor: "divider", bgcolor: "rgba(227,60,36,0.02)" }}>
                <Typography variant="h6" fontWeight={700} gutterBottom sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                  📄 Order Documents
                </Typography>
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                  Your order is delivered! You can now view and print the invoices.
                </Typography>
                <Stack spacing={1.5}>
                  <Button 
                    variant="outlined" 
                    ...
                    fullWidth 
                    component="a" 
                    href={`/orders/${order._id}/print?type=bill`}
                    target="_blank"
                  >
                    Download Order Receipt (Bill)
                  </Button>
                  <Button 
                    variant="outlined" 
                    color="primary" 
                    fullWidth 
                    component="a" 
                    href={`/orders/${order._id}/print?type=invoice`}
                    target="_blank"
                  >
                  ...
                  <Button 
                    ...
                    fullWidth 
                    component="a" 
                    href={`/orders/${order._id}/print?type=gst`}
                    target="_blank"
                  >
                    Download Platform GST Invoice
                  </Button>
                </Stack>
              </Paper>
            )}
