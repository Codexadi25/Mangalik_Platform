...
export const NAV_BY_ROLE = {
  superadmin: [
    ...
    { label: "Server Defender", path: "/admin/defender", icon: "Security" },
    { label: "Lifeline", path: "/lifeline", icon: "Support", newTab: true },
  ],
  admin: [
  ...
  vendor: [
    { label: "Seller Central", path: "/vendor/seller-central", icon: "Storefront" },
  ...
  deliveryPartner: [
    { label: "XpressD Overview", path: "/delivery/xpressd", icon: "Dashboard" },
